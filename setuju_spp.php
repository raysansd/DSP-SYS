			...
			<?php
				...
				echo "
					<tr>
						...
						<td>";	
						if ($data_spp['keterangan']!='' && $data_spp['keterangan']!='LUNAS') {
							echo "<a class='btn btn-success' href='proses_setuju_spp.php?nis=$nis&aksi=terima&id=$data_spp[id_spp]'>Terima</a> 
							<a class='btn btn-danger' href='proses_setuju_spp.php?nis=$nis&aksi=tolak&id=$data_spp[id_spp]'>Tolak</a>";
							}else{
