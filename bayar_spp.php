				...
				echo "
					<tr>
						...
						if ($data_spp['no_bayar']=='') {
							echo "<a class='btn btn-success' href='proses_bayar_spp.php?nis=$nis&aksi=bayar&id=$data_spp[id_spp]'>bayar</a> ";

							}else{
								echo "<a class='btn btn-danger' href='proses_bayar_spp.php?nis=$nis&aksi=batal&id=$data_spp[id_spp]'>batal</a>";
							}
							echo "</td>
					</tr>
							";
